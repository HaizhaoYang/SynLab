function [kb avgdx avgdy kk1 kk2] = SS_ct_polar(num_direction,fff,SPg,NB,rad,is_real,R_low,R_high,epsl,red,t_sc, s_sc,is_cos,  wedge_length_coarse)
%Input:
%fff is the image
...
if(1)
    ...
    avgdx = zeros(NB(1)+1,NB(2)+1,t1,t2);
    avgdy = zeros(NB(1)+1,NB(2)+1,t1,t2);
