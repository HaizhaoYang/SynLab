...
for cnt = 1:6
    ...
    coefCell = gdct2_fwd(ffi,is_real,is_unif,xi,yi,typeNUFFT,[SPx SPy],R_high,R_low,rad);
    norm1 = norm(ffi,2);
    norm2 = 0;
    ...
    norm2 = sqrt(norm2);
    [norm1 norm2 norm3]
    ffr = gdct2_inv(coefCell,Nx,Ny,is_real,R_high,R_low);
    ...
    [ss_energy coefCell coefTensor LocWavVecx LocWavVecy] = ss_ct2_fwd(ffi,[SPx SPy],R_low,R_high,NB,...
        rad,is_real,is_unif,typeNUFFT,xi,yi,epsl);
